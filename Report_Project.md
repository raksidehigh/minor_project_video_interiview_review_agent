# Video Interview Assessment System: Comprehensive Technical Report

**Version:** 2.4.0  
**Date:** November 28, 2025  
**Authors:** Rakshit Jain, Hitesh Joshi
...
4. [Agentic Workflow & Logic (Deep Dive)](#4-agentic-workflow--logic-deep-dive)
...
11. [Data Models & Schemas (TypedDict Spec)](#11-data-models--schemas-typeddict-spec)
12. [Prompt Engineering & LLM Configuration](#12-prompt-engineering--llm-configuration)
13. [GCS Storage & Workspace Management](#13-gcs-storage--workspace-management)
14. [Performance Optimization & Memory Management](#14-performance-optimization--memory-management)
15. [Speech-to-Text Configuration](#15-speech-to-text-configuration)
...
### 16.1 Frontend Interface Screenshots

#### Figure A-1: Candidate Login Screen
*[screenshot-login-screen]*  
*Description: The secure entry point where candidates enter their personal details (Name, Email, Date of Birth).*

#### Figure A-2: System Check & Camera Verification
*[screenshot-system-check]*  
*Description: The interface for checking camera/microphone permissions and capturing the reference profile picture.*

#### Figure A-3: Active Interview Recording
*[screenshot-recording-interface]*  
*Description: The main interview view showing the current question, live camera feed, recording timer, and control buttons.*

#### Figure A-4: Assessment Results Dashboard
*[screenshot-results-page]*  
*Description: The final screen displayed to candidates, showing overall score, pass/fail status, and detailed feedback.*

---

### 16.2 Backend & Infrastructure Screenshots

#### Figure A-5: Google Cloud Run Dashboard
*[screenshot-cloud-run-metrics]*  
*Description: Real-time metrics showing request latency, container instance count, CPU/memory utilization during load testing.*

#### Figure A-6: Google Cloud Storage Bucket Structure
*[screenshot-gcs-bucket]*  
*Description: The hierarchical folder structure in GCS showing user data organization (`user_id/profile_images/`, `user_id/interview_videos/`).*

#### Figure A-7: Application Logs (Structured JSON)
*[screenshot-json-logs]*  
*Description: Structured logs from the Python AI service showing step-by-step LangGraph workflow execution with timestamps.*

#### Figure A-8: Database Records (PostgreSQL)
*[screenshot-database-table]*  
*Description: View of the `assessments` table showing stored final scores, decisions, and timestamps for recent candidates.*

---

### 16.3 AI Agent Processing Flow

#### Figure A-9: LangGraph Workflow Visualization
*[screenshot-langgraph-flow]*  
*Description: Visual representation of the 6-agent workflow showing parallel and sequential execution paths.*

#### Figure A-10: Gemini API Response Sample
*[screenshot-gemini-response]*  
*Description: Example JSON response from Gemini 2.5 Flash showing technical content evaluation with scores and reasoning.*
